  ...
  return (
    <>
      <div className='grid grid-cols-1 lg:grid-cols-2 gap-5 mt-16 flex-wrap' style={{ backgroundColor: "rgba(239, 244, 255)" }}>
        ...
        <p className="text-center text-gray-500">Already have an account<a className="text-blue-500">Log in</a></p></div>
          ...
          <form className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-5 m-5 p-5">
            ...
            <div className="flex flex-col md:flex-row justify-evenly gap-6 col-span-2 px-2">
              <div className='flex flex-1 flex-row justify-evenly  items-center px-2 border rounded-md border-gray-500 h-30 relative'>
                ...
                <div className="size-12 rounded-full bg-blue-500/50 ml-2"></div>
                <div className="ml-4">
              ...
              <div className='flex flex-1 flex-row justify-evenly  items-center px-2 border rounded-md border-gray-500 h-30 relative'>
                ...
                <div className="size-12 rounded-full bg-green-500/50 ml-2"></div>
                <div className="ml-4">
            ...
            <div className="flex flex-row text-gray-500 w-full justify-items-start mt-1.5 col-span-2"><input type="checkbox"></input><p className="w-full ml-2">I agree to the <a className="text-blue-500">Terms of Service</a> and <a className="text-blue-500">Privacy Policy</a></p></div>
            ...
            <p className="col-span-2 text-gray-500 mb-2">By signing up, you agree to our <a className="text-blue-500">Terms of Service</a> and <a className="text-blue-500">Privacy Policy.</a></p>
          </form>
