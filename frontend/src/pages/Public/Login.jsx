...
const Signup = () => {
  return (
    <>
      <div className='grid grid-cols-1 lg:grid-cols-2 gap-5 mt-14 flex-wrap' style={{ backgroundColor: "rgba(239, 244, 255)" }}>
        ...
        <div className='h-10/12 w-11/12 my-5 p-5 shadow-2xl rounded-md bg-white'>
          <form className="p-5 flex flex-col justify-evenly">
            ...
            <Button btnName="Log In" className="w-6xl mt-10"></Button>
